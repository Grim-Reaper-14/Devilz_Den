...
GTA_Build_Registry::GTA_Build_Registry()
{
    ...
    current.targets = {
        ...
        {GTA_Runtime_Target_Id::IsSessionStarted, GTA_Runtime_Target_State::Unknown, false, "IsSessionStarted", "Optional GTA Online session-state capability used by personal-vehicle transactions"},
